Feature: Create Users API
  Background:
    ...
    Given The current date is "2024-12-23T00:00"

  Scenario: Create a new user that is 24 years old and categorize them as young-adult
    When I create a new user with the following details:
      | name              | birthday   |
      | Gabriel Batista   | 2000-01-01 |
